...
def show_weather(text=None):
    print('get city')

    # if not city[0][0]:
    #     return 'Ви не зареєстрували місто, тому ця функція недоступна. Напишіть в чат настуне повідомлення щоб ' \
    #            'зареєструвати:\n' \
    ...
    result = ''
    w = weather.Weather(id, text_data=text)
