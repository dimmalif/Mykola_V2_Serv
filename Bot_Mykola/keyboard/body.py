...
async def reg(message: types.Message):
    await message.answer('Ви успішно зареєструвались! Додайте дані про ваше місце знаходження і зможете слідкувати за '
                         'погодою.\n'
                         'Для цього напишіть в чат: "Я проживаю в  <Ваше місто в називному відмінку>"',
...
async def reg_city(message: types.Message):
    res = re.findall(r'Я проживаю [ув] (.+)', message.text)
    print(res)
